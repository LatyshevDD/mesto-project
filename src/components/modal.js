...
export const formElement = profileEditPopup.querySelector('.form');
export const nameInput = formElement.querySelector('.form__input-text_type_name');
export const jobInput = formElement.querySelector('.form__input-text_type_profession');
